...
const DD = () => {
  return (
    <div>
      <div className="Second-main px-3 m-0 mt-7 bg-[#FCDA69]  ">
        <div className="hero1 justify-between py-5 mx-2 flex">
          <div className="md:pt-32 pt-8  hero1-a">
            <span className="">
              <div className=" text-[#8873EF] text-[10px]  md:text-[18px] origin-top-left -rotate-45   ">
                Hello!
              </div>
              ...
              <div className="text-[8px]  md:text-[30px]">
                Hi! I’m a UI/UX Designer - creating bold & brave <br />
                interface design for companies all across the world.
              </div>
            </span>
            <img src="/55.png" className="md:w-40  w-20  pt-24 " alt="" />
          </div>
